...
#GIT_REPOSITORY=http://github.com/passport/session-server.git
GIT_HOME=/search/build/session.git-deploment
BUILD_HOME=/search/build/session.build-deploment
...
mv -f passport-session-web/target/passport-session-web.war $WORK_DIR/ROOT.war
